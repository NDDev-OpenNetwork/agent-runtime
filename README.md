...
```sh
go install github.com/NDDev-OpenNetwork/agent-runtime/cmd/agent-runtime@v0.1.2
...
The current release is `v0.1.2`; the line started at `v0.1.1`: this module path is
